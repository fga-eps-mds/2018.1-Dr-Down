# Generated by Django 2.0.3 on 2018-05-10 00:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heart_test', models.FileField(upload_to='media/medicalrecords', verbose_name='Heart Test')),
                ('ear_test', models.FileField(upload_to='media/medicalrecords', verbose_name='Test of the Ear')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.HealthTeam', verbose_name='Author')),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.Patient', verbose_name='Patient')),
            ],
            options={
